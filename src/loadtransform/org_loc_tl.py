...
stage_table_name = "V_ORG_LOC"
temp_table_name = "TEMP_ORG_LOC_LU"
target_table_name = "DWH_ORG_LOC_LU"
identifier = "ORG_ID"
...
dwh_lu_load_query_part1 = f"""
                ...
                VALUES(COALESCE((SELECT MAX(ORG_ID) FROM {temp_table_name} WHERE ORG_ID>=0), 0) + RANK() OVER (ORDER BY ORG_ID),
