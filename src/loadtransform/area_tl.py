...
stage_table_name = "V_AREA_TR"
temp_table_name = "TEMP_AREA_LU"
target_table_name = "DWH_AREA_LU"
identifier = "AREA_ID"
...
dwh_lu_load_query_part1 = f"""
                ...
                VALUES(COALESCE((SELECT MAX(AREA_ID) FROM {temp_table_name} WHERE AREA_ID>=0), 0) + RANK() OVER (ORDER BY AREA_ID),
