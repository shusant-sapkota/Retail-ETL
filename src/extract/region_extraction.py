...
data = region_object.fetchAll(queryString)
columns = region_object.fetchHeader(queryString)
...
# Getting the region to save the extracted data file in local machine
...
region_snowflake.executequery(stage_upload_query)
...
region_snowflake.executequery(stage_table_creation_query)
...
region_snowflake.executequery(stage_table_truncate_query)
...
region_snowflake.executequery(stage_table_load_query)
