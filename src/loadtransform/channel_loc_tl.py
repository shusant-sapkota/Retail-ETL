...
stage_table_name = "V_CHANNEL_LOC"
temp_table_name = "TEMP_CHANNEL_LOC_LU"
target_table_name = "DWH_CHANNEL_LOC_LU"
...
#creating V_CHANNEL_LOC temp table
...
#creating V_CHANNEL_LOC target table
...
dwh_lu_load_query_part1 = f"""
                ...
                VALUES(COALESCE((SELECT MAX(CHANNEL_ID) FROM {temp_table_name} WHERE CHANNEL_ID>=0), 0) + RANK() OVER (ORDER BY CHANNEL_ID),
