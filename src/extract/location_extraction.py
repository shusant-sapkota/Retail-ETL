...
data = location_object.fetchAll(queryString)
columns = location_object.fetchHeader(queryString)
...
# Getting the location to save the extracted data file in local machine
...
location_snowflake.executequery(stage_upload_query)
...
location_snowflake.executequery(stage_table_creation_query)
...
location_snowflake.executequery(stage_table_truncate_query)
...
location_snowflake.executequery(stage_table_load_query)
