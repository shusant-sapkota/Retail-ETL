...
data = area_object.fetchAll(queryString)
columns = area_object.fetchHeader(queryString)
...
# Getting the area to save the extracted data file in local machine
...
area_snowflake.executequery(stage_upload_query)
...
area_snowflake.executequery(stage_table_creation_query)
...
area_snowflake.executequery(stage_table_truncate_query)
...
area_snowflake.executequery(stage_table_load_query)
