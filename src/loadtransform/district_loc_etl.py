...
stage_table_name = "V_DISTRICT_LOC"
temp_table_name = "TEMP_DISTRICT_LOC_LU"
target_table_name = "DWH_DISTRICT_LOC_LU"
...
#creating V_DISTRICT_LOC temp table
...
#creating V_DISTRICT_LOC target table
...
dwh_lu_load_query_part1 = f"""
                ...
                VALUES(COALESCE((SELECT MAX(DISTRICT_ID) FROM {temp_table_name} WHERE DISTRICT_ID>=0), 0) + RANK() OVER (ORDER BY DISTRICT_ID),
