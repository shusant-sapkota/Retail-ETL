...
data = district_object.fetchAll(queryString)
columns = district_object.fetchHeader(queryString)
...
stage_creation_query = raw_stage_query_generator()
district_snowflake.executequery(stage_creation_query)
...
district_snowflake.executequery(stage_upload_query)
...
district_snowflake.executequery(stage_table_creation_query)
...
district_snowflake.executequery(stage_table_truncate_query)
...
district_snowflake.executequery(stage_table_load_query)
